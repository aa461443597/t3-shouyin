...
$(function(){
	...
	$("#coupon").change(function(){//优惠修改
		...
		var pay_price = Number($("#pay_price b").html()-coupon_nom);
		pay_price = Math.round(pay_price*100)/100;
...
function generate_order(){
	...
	//时间字符串+4为随机数 组成订单编号
	var order_code =  s_time+""+parseInt(10*Math.random())+""+parseInt(10*Math.random())+""+parseInt(10*Math.random())+""+parseInt(10*Math.random());
