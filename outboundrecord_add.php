				...
				<div class="inbox-details-default">
					...
					<div class="inbox-details-body" id="input_box">
						<form class="com-mail info_input">
							...
							<fieldset>
								<label>出库数量</label>
								<input type="text" id="outbound_count"  value="" placeholder="无信息">
							</fieldset>
							<fieldset>
								<label>出库门店</label>
								<input type="text" id="outbound_address"  value="" placeholder="无信息">
							</fieldset>
...
function data_mall_update(){
	...
	var outbound_count = $("#outbound_count").val();
	var outbound_address = $("#outbound_address").val();
	
	$.ajax({
		type:"POST",//接口类型
		url:"vipformall/outboundrecord_insert_record.php",//接口url
		dataType:"json",//请求类型
		...
		success: function(request){
			...
			if(request == 1){
				tips("入库成功",2000);
				setTimeout(function(){gopage("outboundrecord_add.php");}, 2000); 
			}else{
