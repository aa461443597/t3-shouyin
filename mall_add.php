				...
				<div class="inbox-details-default">
					...
					<div class="inbox-details-body" id="input_box">
						<form class="com-mail info_input">
							...
							<fieldset>
								<label>操作人</label>
								<input type="text"  id="last_operator" value="" placeholder="无信息" >
							</fieldset>
							<input type="button" onClick="data_update()" value="发布商品" style="margin-left: 12% !important; padding:0.8em 2.5em !important;">
						</form>
					</div>
				</div>
			</div>
...
function data_update(){
	...
	data_mall_update(mall_data_json,"vipformall/commoditydata_insert_commodity.php");
}
