<?php
	...
	$sql="INSERT INTO inbound_record (id,bar_code, commodity_name, inbound_count,inbound_date,inbound_address,last_operator,last_time) ".
	" VALUES (null,'$bar_code','$commodity_name', $inbound_count,'$inbound_date','$inbound_address','$last_operator','$last_time')";
	try{
		mysql_query($sql, $con);
