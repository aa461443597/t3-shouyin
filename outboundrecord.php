					...
					<div class="mailbox-border">
						<div class="mail-toolbar clearfix" style="padding:0 0 1rem 0;">
							<div class="float-left">
								<div class="btn btn_1 btn-default mrg5R" style="width: auto" onClick="gopage('outboundrecord_add.php')">
									商品出库
								</div>
...
<script>
	...
	function mall_list(){
		$.ajax({
			type:"POST",//接口类型
			url:"vipformall/outboundrecord_select_recordList.php",//接口url
			dataType:"json",//请求类型
			...
			success: function(request){
				...
				$.each(request,function(index,data){
					...
					<tr class="unread checked" id="'+data.id+'">\
						...
						<td>'+data.outbound_count+'</td>\
						<td>'+data.outbound_date+'</td>\
						<td>'+data.outbound_address+'</td>\
